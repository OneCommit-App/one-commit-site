...
- Email: legal@onecommit.us
- Address: OneCommit, Legal Department, [Address]
  ...
  const handleBetaSubmit = async (e) => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .insert([
          {
            first_name: betaFormData.firstName,
            last_name: betaFormData.lastName,
            email: betaFormData.email,
            sport: betaFormData.sport,
            phone: betaFormData.phoneNumber
          }
        ])
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <Card className="bg-[#e8f0ed] border-[#c0d8d0]">
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#e8f0ed]0 rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center">
                    <div className="w-16 h-16 bg-[#235d48] text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">
                      1
                    </div>
                      ...
                      <form onSubmit={handleBetaSubmit} className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                          ...
                          <div>
                            ...
                            <Select value={betaFormData.graduationYear} onValueChange={(value) => setBetaFormData({...betaFormData, graduationYear: value})}>
                              <SelectTrigger>
            ...
            <Dialog open={storyModalOpen} onOpenChange={setStoryModalOpen}>
              <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="prose max-w-none">
                  <p>In early 2024, I began my journey to becoming a college track athlete. I knew who I was as an athlete and a student, but didn\\\"t know anything about where I could fit. After finding coach contact emails and writing the same introductory email over and over again, I decided to write some code to do it for me — thus, OneCommit was born.</p>

                  <p>The recruiting process is broken for most athletes. Unless you\\\"re in the top 1% of performers, you\\\"re left to navigate a complex, time-consuming process with little guidance. Traditional recruiting services are expensive and often ineffective, leaving athletes and families frustrated.</p>

                  <p>OneCommit changes this by putting the power back in the athlete\\\"s hands. Our platform uses intelligent matching to identify schools where you have the best chance of success, both athletically and academically. We then help you craft personalized outreach emails and track engagement to optimize your recruiting strategy.</p>

                  <p>What makes OneCommit different is that we work as your recruiting agent. We don\\\"t just provide a platform — we actively help you succeed. Our system learns from coach responses and adapts your strategy in real-time, ensuring you\\\"re always putting your best foot forward.</p>

                  <p>As a student-athlete myself, I understand the challenges you face. That\\\"s why I built OneCommit to be the recruiting tool I wish I had when I started my journey. We\\\"re here to level the playing field and help every athlete find their perfect college match.</p>
                </div>
              </DialogContent>
            </Dialog>
